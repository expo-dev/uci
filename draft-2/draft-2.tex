...
the side to move is black and there is a white pawn at index {\it n}\ot4 and at
{\it n}\ot2 and {\it n}\ot3 the board is empty. If the en passant target is
{\it n}\ot6 for some {\it n}, the side to move is white and there is a black
pawn at index {\it n}\ot5 and at {\it n}\ot6 and {\it n}\ot7 the board is empty.
