...
sections 1–5 is normative (except as described in {\it Conventions} below).
...
{\caps api}s may expect paths encoded in the local code page), and so the path
...
\vskip-\parskip
\greybox{This precludes the proper use of some encodings, such as {\caps utf-16}
or {\caps utf-32} (since in {\caps utf-16} and {\caps utf-32}, the byte \hex{0a}
appears in the encodings of various scalar values, whereas in {\caps utf-8}, the
byte \hex{0a} only appears in the encoding for \uni{000a line feed}).}
